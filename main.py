...
#     produto.nome = request.form['txtNome']
...
#     produto.preco_compra = request.form['txtPreçoCompra']
#     produto.preco_venda = request.form['txtPreçoVenda']
...
#     # Ao atualizar a bebida, o usuário é redirecionado ao /lista
